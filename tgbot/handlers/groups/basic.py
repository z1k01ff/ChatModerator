...
/title [титул*] - Встановити титул (можна відправити відповідь на повідомлення, щоб встановити титул користувачу) <i>потрібно мати рейтинг 100 і вище</i>
/history - Історія 200 повідомлень (стисло). <i>Потрібно мати рейтинг 600 і вище</i>
